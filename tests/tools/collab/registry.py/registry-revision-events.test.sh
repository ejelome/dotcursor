...
"$ROOT/tools/collab/registry.py" init --agent-id codex "Registry Revision Events" >/dev/null
...
log="$("$ROOT/tools/collab/registry.py" log "$TARGET")"
...
"$ROOT/tools/collab/registry.py" set "$TARGET" description "Updated description" --caller-role mod >/dev/null
