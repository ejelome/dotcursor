...
2. Repo-owned source files and policy documents:
   - Root adapters: `_CURSOR.md`, `CLAUDE.md`, `AGENTS.md`, `REPOSITORY.md`, `README.md`, `.gitignore`
...
3. Derived runtime or generated outputs:
   ...
   - Ignored runtime state (not source): `.collabs/`, `.claude/`, `projects/`, `extensions/`, `ide_state.json`, `skills-cursor/`, `plugins/`, `skills/`, `plans/`, `subagents/`
...
- Do not edit by hand:
  ...
  - Any path matched by `.gitignore` (e.g. `.collabs/`, `.claude/`, `projects/`, `extensions/`, `ide_state.json`, `skills-cursor/`, `plugins/`, `skills/`, `plans/`, `subagents/`) — runtime state, never source.
