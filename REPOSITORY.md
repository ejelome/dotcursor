...
- Do not edit by hand:
  - Files under `generated/` — regenerated by `commands/collab/engine/lifecycle-doc.py`, `platform/tooling/command-reference.py`, and `platform/tooling/sync-framework-boundaries.sh`.
