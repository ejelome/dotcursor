...
This file is the canonical owner of registry field lifecycle rules. Both `registry.schema.json` (load-time validation) and any load-time validation note in `tools/collab/registry.py` must link to this file rather than restating the rules inline.
