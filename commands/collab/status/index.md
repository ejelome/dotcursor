...
2. Call `tools/collab/registry.py status <target>`.
...
- **Counter displayed:** The `revision` field is the write-guard counter sourced from the `revision` field in `registry.json`. See [schema-evolution.md](../../../core/collab/schema-evolution.md) for the counter lifecycle. The helper-output label for this value may differ from the stored field name.
