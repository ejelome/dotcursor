...
This document defines the join-time model and harness for each collab role, a generated effort projection, and fallback. It supplements [`_agent-effort.md`](../../core/collab/_agent-effort.md) (effort levels) and [`_agent-lifecycle.md`](_agent-lifecycle.md) (lifecycle command timing). For the role schema and roster, see [`_core/agent-role.md`](../../_core/agent-role.md); for agentId precedence and capture semantics, see [`join.md`](join.md).
