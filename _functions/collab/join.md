...
3. Read `../../core/collab/_roles/<role>.json`. If unreadable, **ABORT**: role file unreadable; name the expected path.
...
- **Role data boundary:** Role JSON files live under `core/collab/_roles/` as shared command-owned data, not route playbooks.
