...
1. Read [_invariants.md](../../core/collab/_invariants.md) before executing; call the relevant helper fresh and do not trust prior reads from conversation context (Invariant #4). Read the resolved registry. If unreadable, **ABORT**: registry unreadable; name the path.
