...
- **After each Handoff turn:** run `/compact` before preparing the subagent. The Handoff deliverable shape (`writeScope`, `validationCommands`) is defined in [`_functions/collab/_handoff-shape.md`](_functions/collab/_handoff-shape.md).
